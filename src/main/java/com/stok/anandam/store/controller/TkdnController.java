...
public class TkdnController {
        ...
        /**
         * GET /api/v1/tkdn – filter: isTkdn, kategori, search + spesifikasi (processor,
         * ram, ssd, hdd, vga, layar, os). Semua filter AND, contains case-insensitive.
         */
        @GetMapping
        ...
        /**
         * GET /api/v1/tkdn/categories – daftar nilai unik kategori untuk dropdown (satu
         * request, tanpa pagination).
         */
        ...
        @GetMapping("/{id}")
        public ResponseEntity<WebResponse<Tkdn>> getTkdnDetail(@PathVariable(name = "id") Integer id) {
