    ...
    public WebResponse<List<PenjadwalanResponse>> getListTugas(TipeTugas tipe, StatusJadwal status, String username) {
        ...
        List<PenjadwalanResponse> responses = listTugas.stream().map(tugas -> {
            ...
            return PenjadwalanResponse.builder()
                    ...
                    .kecamatan(tugas.getKodepos() != null ? tugas.getKodepos().getKecamatan() : tugas.getKecamatan())
                    .desaKelurahan(tugas.getKodepos() != null ? tugas.getKodepos().getDesaKelurahan() : tugas.getDesaKelurahan())
                    .kabupatenKota(tugas.getKodepos() != null ? tugas.getKodepos().getKabupatenKota() : tugas.getKabupatenKota())
